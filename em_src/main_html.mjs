import EM_Module from '../em_bin/emscripten.mjs'

console.log('module loaded, waiting for initialize..')

EM_Module().then((em_runtime) => {
    /**
     ...
     */
    const EMSCRIPTEN_ITM_P2P_TLS_Ex_str = em_runtime.cwrap('EMSCRIPTEN_ITM_P2P_TLS_Ex_str', 'string', [
